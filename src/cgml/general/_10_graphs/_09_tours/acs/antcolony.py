...
class AntColony:
    ...
    def iteration(self):
        ...
        self.iter_counter += 1
        print
        "iter_counter = %s" % (self.iter_counter,)
        for ant in self.ants:
            print
            "starting ant = %s" % (ant.ID)
            ant.start()
    ...
    def update(self, ant):
        ...
        if self.ant_counter == len(self.ants):
            ...
            print
            "Best: %s, %s, %s, %s" % (self.best_path_vec, self.best_path_cost, self.iter_counter, self.avg_path_cost,)
